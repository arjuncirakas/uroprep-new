...
const UrologistSidebar = ({ isOpen, onClose, onOpenAddPatient }) => {
  ...
  const navigationItems = [
    ...
    { name: 'Patients', icon: FaUsers, path: '/urologist/patients', active: location.pathname === '/urologist/patients' },
    { name: 'Appointments', icon: FaCalendarAlt, path: '/urologist/appointments', active: location.pathname === '/urologist/appointments' },
    { name: 'Tasks', icon: FaTasks, path: '/urologist/tasks', active: location.pathname === '/urologist/tasks' },
    { name: 'Reports', icon: FaChartBar, path: '/urologist/reports', active: location.pathname === '/urologist/reports' },
  ];
